...
ENV MLSERVER_MODELS_DIR=/mnt/models \
    ...
    LD_LIBRARY_PATH=/usr/local/nvidia/lib64:/opt/conda/lib/python3.11/site-packages/nvidia/cuda_runtime/lib:$LD_LIBRARY_PATH \
...
COPY --chown=1000:0 ./models/ /mnt/models/
